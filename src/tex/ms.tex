...
The inferred mass distribution closely resembles the true, simulated distribution, and the injected value of \Ho (\variable{output/H0_FID.txt} km/s/Mpc) is consistent with its inferred posterior (\result{X}).
