...
The source frame mass is different for each possible value of \Ho{} and \Omm{}, so the hyperparemeters are defined in different locations for each draw from the hyperposterior. % can remove this sentence.
...
\end{itemize}
\acknowlegements{The authors thank Reed Essick, Utkarsh Mali, Ben Farr, Maya Fishbach, ... for helpful conversations}
