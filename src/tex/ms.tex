...
Additionally, the posterior on \Ho{} is distinct from its prior distribution (uniform in the range $[30\Hunits,60\Hunits]$ \jme{[upper bound cannot be correct :)]}, indicating that the data is informative despite the flexibility of the population model.
