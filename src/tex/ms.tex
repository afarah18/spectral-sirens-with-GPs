...
Figure~\ref{fig:parametric bias} shows recovered posteriors on \Ho{} as inferred from 50 mock catalogs using both the \bpl{} and \plp{} parametric models.
...
Regardless, this systematic offset further demonstrates that incorrect parametric models induce a systematic bias in cosmological inference rather than an increased statistical uncertainty. 
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{figures/q_comparison.pdf}
