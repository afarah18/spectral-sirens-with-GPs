...
This result also implies that we can expect to measure \Ho{} to \result{\variable{output/nonparh0percent.txt}\%} by the end of the LVK's fifth observing run using this method.
