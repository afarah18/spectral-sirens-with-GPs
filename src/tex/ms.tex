...
%     \caption{Recovered posteriors on \Ho{} from spectral siren analyses on 50 mock catalogs with the \plp{} (green) and \bpl{} () parametric models. The true, injected value is shown by a vertical black line. }
