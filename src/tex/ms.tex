...
We find that both the source mass model and cosmological parameters are correctly reconstructed, and predict a $\variable{output/nonparh0percent.txt}\%$ measurement of \Ho{} and a $\variable{output/nonparhzpercent.txt}\%$  measurement of $H(z=\variable{output/mostsensitivez.txt})$ ($1-\sigma$).
