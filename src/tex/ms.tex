...
When applied to data from next-generation detectors, this method will measure \new{all cosmological parameters that govern $H(z)$, such as the curvature parameter, $\kappa$, matter density, \Omm, dark energy density, $\Omega_\Lambda$, and dark energy equation of state parameter, $w$.}
...
We encourage readers to click these hyperlinks to verify or reproduce the results and methods of this work. The git repository associated to this study allows anyone to re-build the entire manuscript, and is publicly available at \GitHubURL{} and \url{https://zenodo.org/records/11199928}.
