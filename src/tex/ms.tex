...
We encourage readers to click these hyperlinks to verify or reproduce the results and methods of this work. The git repository associated to this study is publicly available at \GitHubURL{}, which allows anyone to re-build the entire manuscript.
