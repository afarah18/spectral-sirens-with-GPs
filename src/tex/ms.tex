...
We find \ac{O5} observations to be most sensitive to \result{$H(z=\variable{output/mostsensitivez.txt})$}, which results in similarly informative constraints on \Omm{} as on \Ho.
\begin{itemize}
