...
Galaxy catalogs are anticipated to be complete to \result{$z=X$} at that time, and type 1a supernovae are expected to be observable to $z\sim Y$ \comment{cite Rubin papers?}, making the spectral siren method uniquely positioned to measure the expansion of the universe at high redshift.
